...
- **V0.4** — Intelligence/Agents. **EM ANDAMENTO** (2026-08-16, DEC-006/DEC-007): Financial Analyst e Savings Coach implementados e em produção, via Groq (llama-3.3-70b-versatile), sem custo. Faltam Behavior Agent, Goal Agent, Planning Agent, Investment Education Agent — cada um entra em uma etapa própria, não de uma vez.
- **V0.5** — Reports.
