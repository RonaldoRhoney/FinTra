...
- **V0.6** — Open Finance. **Continua BLOQUEADA** (2026-08-16, DEC-011). Investigação real confirmou que não há caminho zero-custo aplicável ao FinTra: integradores certificados cobram (Pluggy ~R$2.500/mês, Belvo ~R$6.000/mês); a oferta gratuita "Meu Pluggy" da Pluggy é restrita a uso pessoal/um CPF, não a produto multiusuário. Nenhuma das 8 perguntas de `docs/foundation/open-finance/PARTICIPATION_MODEL.md` foi respondida — decisão de pagar um integrador ou virar participante direto continua pendente do usuário.
- **V0.7** — Alerts.
